...
class GenericEntity(ABC):
    ...
    world: None | World = field(init=False, default=None, repr=False)
    ...
    def __post_init__(self, position_from_sequence: Sequence[float]) -> None:
        ...
        if self.world and not self.is_in_world_bounds:
    ...
    @property
    def is_in_world_bounds(self) -> bool:
        ...
        if self.world is None:
            ...
            raise ValueError(err_msg)
        return self.world.position_is_in_bounds(self.position)
